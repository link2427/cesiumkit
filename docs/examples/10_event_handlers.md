# Click interactivity with custom JavaScript

_Example — Registers a screen-space event handler that selects the clicked entity._
...
```bash
python examples/10_event_handlers.py
